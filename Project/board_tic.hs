...
getAtIndex :: Board Symbol -> Int -> Symbol
...
setAtIndex :: Board Symbol -> Symbol -> Int -> Board Symbol
...
checkWin :: Board Symbol -> Maybe Symbol
...
randomMove :: Board Symbol -> IO Int
randomMove b = do
    pos <- randomRIO(1,9) 
...
finishComputerMove :: Board Symbol -> IO()
...
makeMove :: Board Symbol -> Symbol -> Int -> Maybe (Board Symbol)
...
startGame :: Board Symbol -> Bool -> Symbol -> IO ()
